# -*- coding: utf-8 -*-
"""
Created on Sun Nov 06 19:12:26 2016
...
def ele_hop(conf_new,L,mc,md,v,u):
    ...
    ratio,G_temp=Dyson_update(conf_new,s_conf_index,hop_conf_index,L,j,mc,md,v,u)    
...
def warm_up(Nwarmup,conf,L,mc,md,v,u):
    ...
    while Nwarmup:
        count=count+1
        Nwarmup=Nwarmup-1
        G=G_and_Idx(conf,L,j,mc,md,v,u)
...
while True: 
    ...
    while loop:
        loop=loop-1 
        G=G_and_Idx(conf_new,L,j,mc,md,v,u)
        for i in range(3*L**2):
