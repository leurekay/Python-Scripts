# -*- coding: utf-8 -*-
"""
Created on Tue Oct 04 20:54:27 2016
fix two errors in version run:
1:E_local
2:left right down....
@author: aa
"""
...
conf_new=np.array([[1, 0, 0, 1, 0, 2, 2, 0, 0, 1, 0, 0, 0, 2, 2, 0, 1, 1, 1, 1, 0, 2,
        2, 0, 1, 0, 1, 1, 0, 0, 2, 2, 0, 1, 0, 1, 0, 0, 2, 2, 0, 0, 0, 1,
        2, 0, 0, 2, 1, 0, 1, 0, 0, 2, 2, 0, 0, 0, 1, 0, 0, 2, 2, 0, 1, 0,
        1, 0, 2, 2, 0, 0, 0, 1, 1, 1, 0, 0, 2, 2, 1, 0, 1, 0, 2, 2, 0, 0,
        0, 1, 1, 0, 0, 0, 2, 2, 1, 0, 1, 0, 0, 0, 2, 2, 1, 1, 1, 1, 0, 2,
        2, 0, 1, 0, 0, 0, 2, 2, 0, 0, 0, 0, 1, 0, 2, 0, 0, 2, 0, 0, 0, 0,
        2, 0, 0, 2, 0, 0, 1, 0, 2, 2, 0, 0, 0, 1, 0, 1, 2, 2, 0, 0, 0, 0,
        0, 0, 0, 0, 2, 2, 1, 0, 1, 1, 0, 0, 2, 2, 0, 0, 1, 1, 2, 0, 0, 2,
        1, 0, 0, 1, 0, 0, 2, 2, 0, 1, 0, 1, 0, 2, 2, 0, 0, 0, 1, 1, 2, 0,
        0, 2, 0, 1, 1, 1, 0, 0, 2, 2, 0, 1, 1, 1, 2, 0, 0, 2, 1, 0, 0, 1,
        0, 0, 2, 2, 1, 1, 0, 1, 2, 0, 0, 2, 1, 1, 1, 0, 0, 0, 2, 2, 1, 1,
        0, 0, 0, 0, 2, 2, 0, 1, 1, 1, 2, 2, 0, 0, 0, 1, 0, 0, 2, 0, 0, 2,
        0, 0, 0, 0, 2, 0, 0, 2, 1, 0, 0, 1, 2, 0, 0, 2, 0, 1, 1, 1, 2, 0,
        0, 2]])
...
while True:
    ...
    if try_hop != "reject":
        ...
        if samples==sample_goal:
            break
    try_spin=spin_flip1(conf_new,L,mc,md,v,u)
    if try_spin != "reject":
